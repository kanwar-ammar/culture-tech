...
import 'react-modal-video/scss/modal-video.scss';
import img1 from "../Images/talk_1.jpg"
import img2 from "../Images/talk_2.jpg"
import img3 from "../Images/talk_3.jpg"
...
},
{
    id:1,
    title:"Power of a single decision ",
    image:require("../Images/talk_2.jpg"),
    link:"https:/293489023i4092kdmls",
    vidId:"42-I4V9ymYs",
    author:"Nighat Chaodhary"
},
{
    id:1,
    title:"Power of a single decision ",
    image:require("../Images/talk_3.jpg"),
    link:"https:/293489023i4092kdmls",
    vidId:"42-I4V9ymYs",
    author:"Nighat Chaodhary"
},
    ...
    <div className='topPods'>
        <div style={{border:"0.5px Solid white", margin: '20px', borderRadius:"10px" , padding: "30px"}}>
            <div style={{height:"70px"}}>
                ...
                <Link to="/SeeAll" state={{ data: someList,title:someTitle}}   >SeeMore</Link>
                </Typography>
            ...
            <Splide options={ {
                ...
                <SplideSlide>
                    <Card className={classes.cardConf} sx={{borderRadius:'15px', backgroundColor:"black"}}>
                        {/* <div style={{position: 'relative', left: '0', top: '0'}}>
                            ...
                            <div>
                            <CardMedia component="img"  className={classes.podcastImage} src={img1} alt="Live from space album cover" />
                            </div>
                            <CardContent>
                            <Typography gutterBottom variant="body1"  align="left" className='title'>
                ...
                <SplideSlide>
                    <Card className={classes.cardConf} sx={{borderRadius:'15px', backgroundColor:"black"}}>
                        {/* <div style={{position: 'relative', left: '0', top: '0'}}>
                            ...
                            <div>
                            <CardMedia component="img"  className={classes.podcastImage} src={img2} alt="Live from space album cover" />
                            </div>
                        <CardContent>
                ...
                <SplideSlide>
                    <Card className={classes.cardConf} sx={{borderRadius:'15px', backgroundColor:"black"}}>
                        ...
                        <div>
                        <CardMedia component="img"  className={classes.podcastImage} src={img3} alt="Live from space album cover" />
                        </div>
                        <CardContent>
                        <Typography gutterBottom variant="body1" component="div" align="left" className='title' >
