...
{
    id:2,
    title:"Leading from a Distance with Farooq Chaudhry OBE | Questions Dancing through my Mind",
    ...
    <div className='ContListenMain'>
        <div className='contContainer'>
            <div style={{height:"70px"}}>
                ...
                <Link to="/SeeAll" state={{ data: someList }}>SeeMore</Link>
                </Typography>
                {/* <Typography gutterBottom variant="h5" component="div"   sx={{color:'white', padding:"20px" ,float:"right"}} >
                See All
                </Typography> */}
            ...
            <div>
                ...
                <CardMedia component="img"  sx={{  width: 400 ,height:220  ,border:"none"}} src={img1} alt="Live from space album cover" />
                </Box>
                    <CardContent>
                ...
                <Card class="resCard">
                <Box sx={{ width: 500 ,height:220 }}>
                <CardMedia component="img"  sx={{ width: 400 ,height:220 ,border:"none"}} src={img2} alt="Live from space album cover" />
                </Box>
                    <CardContent>
                        <Typography gutterBottom variant="h5" component="div"align="left" className="ContListenTitle">
                ...
                <CardMedia component="iframe" controls sx={{  width:400 ,height:220,border:"none"}} src="https://player.vimeo.com/video/670086956?h=5730515a45" alt="Live from space album cover" />
                </Box>
                    <CardContent>
                        <Typography gutterBottom variant="h5" component="div"  align="left" className="ContListenTitle">
                        Hunza
                ...
                <Card class="resCard">
                <Box sx={{width:400 ,height:220  }}>
                <CardMedia component="img"  sx={{ width:400 ,height:220  ,border:"none"}} src={img5} alt="Live from space album cover" />
                </Box>
                    <CardContent>
                        <Typography gutterBottom variant="h5" component="div" align="left" className="ContListenTitle">
                        Khaas Mulaqat
                ...
                <Card class="resCard">
                <Box sx={{ width: 500 ,height:220 }}>
                <CardMedia component="img"  sx={{width:400 ,height:220 ,border:"none"}} src={img4} alt="Live from space album cover" />
                </Box>
                    <CardContent>
                        <Typography gutterBottom variant="h5" component="div" align="left" className="ContListenTitle">
                ...
                <Card class="resCard">
                <Box sx={{ width: 500 ,height:220 }}>
                <CardMedia component="img"  sx={{ width:400 ,height:220  ,border:"none"}} src={img3} alt="Live from space album cover" />
                </Box>
                    <CardContent>
                        <Typography gutterBottom variant="h5" component="div" align="left" className="ContListenTitle">
