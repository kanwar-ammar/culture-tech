...
export default function ColorTabs() {
    ...
    <ThemeProvider theme={theme}>
      <Box sx={{ width: '100%'}}>
        ...
        <Typography variant="h4" sx={{color:'white', padding:"20px" ,textAlign:"left"}} >
            Dance Tourism
        </Typography>
        {/* <Search>
            <SearchIconWrapper>
        ...
        <Tabs
          ...
          aria-label="primary"
        >
            <Tab sx={{color:"#8A8988", padding:"50px"}} label="National" value="national" />
            <Tab sx={{color:"#8A8988", padding:"50px"}} label="Regional" value="regional" />
            <Tab sx={{color:"#8A8988", padding:"50px"}} label="Mountainous" value="mountainous" />
            <Tab sx={{color:"#8A8988", padding:"50px"}} label="Tribal Dances" value="tribal" />
        </Tabs> 
                <TabPanel value="national" className='SeeAllSubsContainer'>
                    {NationalList.map(item =>(
                    <Card class="resCard">
                    <Box sx={{ width: 500 ,height:220 }}>
                        <CardMedia component="img"  sx={{ width: 400 ,height:220 ,border:"none"}}  src={item.image} alt="Live from space album cover" />
                    </Box>
                    <CardContent>
                        <Typography gutterBottom variant="h5" component="div"align="left" className="ContListenTitle">
                        Leading from a Distance with Farooq Chaudhry OBE | Questions Dancing through my Mind
                        </Typography>
                        <Typography gutterBottom component="div"  variant="body2" align="left" className='title'>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center',float:"right", marginLeft: "auto", paddingRight:"20px",order: 1,pl: 1, pb: 1}}>
                        <Modal vidId={item.vidId} buttonClass="playssButton"></Modal>
                ...
                <div>
                    <Accordion expanded={expanded === 'panel1'} onChange={handlerChange('panel1')}  sx={{backgroundColor:"#1B1E23"}}>
                        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header" sx={{backgroundColor:"#2B2F5C "}}>
                        <Typography sx={{color:"white"}}>PUNJAB</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Grid container spacing={{ xs: 6, md: 5 }} columns={{ xs: 4, sm: 8, md: 16 }} sx={{textAlign: 'center'}}>
                        {punjabReg.map(item =>(
                        <Grid item xs={2} sm={4} md={4}>
                        <Card sx={{ width:230,height:350, display:'inline-block', borderRadius:'15px',  backgroundColor:"black"}}>
                            <div>
                            <CardMedia sx={{ width: 230 ,height:120 ,border:"none"}} component="img" image={item.image}  />
                            </div>
                            <CardContent>
                            <Typography gutterBottom variant="body1" component="div" align="left" className='title'>
                            {item.title}
                            </Typography>
                            <Typography variant="subtitle2" align="left" className='author'>
                            {item.author}
                    ...
                    <Accordion expanded={expanded === 'panel2'} onChange={handlerChange('panel2')} sx={{backgroundColor:"#1B1E23"}}>
                        <AccordionSummary aria-controls="panel2d-content" id="panel2d-header" sx={{backgroundColor:"#2B2F5C"}}>
                    ...
                    <Accordion expanded={expanded === 'panel3'} onChange={handlerChange('panel3')} sx={{backgroundColor:"#1B1E23"}}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header" sx={{backgroundColor:"#2B2F5C"}}>
                    ...
                    <Accordion expanded={expanded === 'panel4'} onChange={handlerChange('panel4')} sx={{backgroundColor:"#1B1E23"}}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header" sx={{backgroundColor:"#2B2F5C"}}>
                    ...
                    <Accordion expanded={expanded === 'panel5'} onChange={handlerChange('panel5')} sx={{backgroundColor:"#1B1E23"}}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header" sx={{backgroundColor:"#2B2F5C"}}>
                        <Typography sx={{color:"white"}}>GILGIT BALTISTAN</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                        <Grid container spacing={{ xs: 6, md: 5 }} columns={{ xs: 4, sm: 8, md: 16 }} sx={{textAlign: 'center'}}>
                        {gilgitReg.map(item =>(
                    ...
                    <Accordion expanded={expanded === 'panel6'} onChange={handlerChange('panel6')} sx={{backgroundColor:"#1B1E23"}}>
                        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header" sx={{backgroundColor:"#2B2F5C"}}>
